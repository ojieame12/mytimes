...
const samples: Record<string, () => string> = {
  '01-booking-confirmation': () =>
    renderEmailHtml({
      ...
      title: 'Confirmed with Oyani.',
      preheader: '10:00–11:00 · SAST · 60 min with Oyani Solis · calendar attached',
      timeBlock: {
      ...
      timeBlockStyle: 'hero',
      personLockup: { role: 'Organizer', name: 'Oyani Solis', email: 'oyani@vision.studio' },
      ...
      whatsNext: [
        ...
        `Replying to this email reaches Oyani directly.`,
      ],
      footerNote: "Sent because you booked a time on Oyani's mytimes board.",
  ...
  '03-cancellation-participant': () =>
    renderEmailHtml({
      ...
      personLockup: { role: 'Organizer', name: 'Oyani Solis' },
      ...
      whatsNext: [
        ...
        `If you didn't mean to cancel, reach out to Oyani directly.`,
      ],
  ...
  '08-managed-booking-resend': () =>
    renderEmailHtml({
      ...
      preheader: 'your booking · 10:00–11:00 · SAST · with Oyani Solis',
      timeBlock: {
        primary: { label: 'Your time', weekday: 'Tuesday', date: '18 May 2026', timeRange: '10:00–11:00', timezone: 'SAST' },
      },
      timeBlockStyle: 'hero',
